...
contract ERC1155GlipPassMeta is ERC1155GlipPass, EIP712MetaTransaction {
    ...
    function __ERC1155GlipPassMeta_init(string memory _name, string memory _symbol, bool _global, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy, address defaultMinter, address forwarder) external initializer {
